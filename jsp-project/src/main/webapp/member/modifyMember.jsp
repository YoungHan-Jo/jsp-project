	...
	<div class="row container">
		...
		<div class="col s12 m3 l3 side-menu">
			<ul class="collection with-header ">
				<li class="collection-header brown lighten-1"><h4>회원정보</h4></li>
				<li class="collection-item hover">내 정보</li>
				<li class="collection-item hover">내가 쓴 글</li>
				<li class="collection-item hover">회원정보 수정</li>
				<li class="collection-item hover">비밀번호 변경</li>
				<li class="collection-item hover">회원탈퇴</li>
			</ul>
		</div>
