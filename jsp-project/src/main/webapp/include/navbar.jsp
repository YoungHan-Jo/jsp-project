<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <nav class="nav-extended brown darken-4">
		<div class="nav-wrapper container">
			...
			<ul id="nav-mobile" class="right hide-on-med-and-down">
				...
				<li><a href="collapsible.html">회원 정보</a></li>
				<li><a href="/member/login.jsp"><button class="waves-effect waves-light btn">로그인</button></a></li>
				<li><a href="/member/login.jsp"><button class="waves-effect waves-light btn">로그아웃</button></a></li>
			</ul>
		</div>
		<div class="nav-content container">
			<ul class="tabs tabs-transparent">
				<li class="tab right"><a href="#test1">Test 1</a></li>
				<li class="tab right"><a class="active" href="#test2">Test
						2</a></li>
	...
	<ul class="collapsible sidenav" id="mobile-demo">
		...
		<li class="center">
			<button class="waves-effect waves-light btn">로그인</button>
		</li>
	</ul>